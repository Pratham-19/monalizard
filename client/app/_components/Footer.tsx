...
const Footer = ({ className }: { className?: string }) => {
  ...
  return (
    <footer
      className={cn(
        "w-full bg-[hsl(var(--primary))] flex justify-between items-center h-12 lg:h-16 rounded-[var(--radius)] px-4 py-6",
        className
      )}
    >
      <div className="flex">
        <Image
          ...
          width={1600}
          height={1600}
          className="p-1.5 w-10 h-10 bg-white rounded-full mr-3"
        />
